...
contract IssuerHandler is BaseHandler, StdAssertions {
    ...
    function issue(
        ...
        uint256 totFee = balanceOfFeeRecipient();
        ...
        uint256 fee = balanceOfFeeRecipient() - totFee;
        trancheStore.ghost_addIssuanceFee(fee);
    ...
    function balanceOfFeeRecipient() public view returns (uint256) {
        return underlying.balanceOf(tranche.feeRecipient());
    }
}

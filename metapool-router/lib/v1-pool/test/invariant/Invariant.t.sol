...
import {BaseHandler} from "@napier/v1-tranche/test/invariant/handlers/BaseHandler.sol";
...
import {TimestampStore} from "@napier/v1-tranche/test/invariant/TimestampStore.sol";
...
contract InvariantTest is Base {
    ...
    function invariant_poolSolvency() public useCurrentTimestamp {
        ...
        // Due to precision loss, the pool may have more Tricrypto LP tokens than the reserve.
        assertGe(tricrypto.balanceOf(address(pool)), pool.totalBaseLpt(), Properties.P_02);
    }

...
contract TestEEtherTranche is BaseTestTranche, EEtherFixture {
    using stdStorage for StdStorage;

    /// @notice Address for setting up the test environment
    address charlie = makeAddr("charlie");

    function setUp() public virtual override(CompleteFixture, EEtherFixture) {
        EEtherFixture.setUp();
    ...
    /// @notice Mint some eETH and shares by depositing large amount of underlying.

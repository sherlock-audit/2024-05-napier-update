...
abstract contract CompleteFixture is AdapterFixture {
    ...
    function setUp() public virtual override {
        ...
        // OVERRIDE
        // - set delta if needed
        // - set maturity, issuance fee and gscalesCache
    ...
    function _deployTranche() internal virtual {
        vm.prank(management);
        tranche = Tranche(factory.deployTranche(address(adapter), _maturity, _issuanceFee));
    ...
    function balanceOfFeeRecipient() public view returns (uint256) {
        return underlying.balanceOf(feeRecipient);
    }

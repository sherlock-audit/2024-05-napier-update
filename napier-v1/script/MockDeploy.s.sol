...
contract MockDeployer is Script {
    ...
    function run() public {
        ...
        address cTranche = factory.deployTranche(address(cAdapter), maturity, issuanceFee);
        address mTranche = factory.deployTranche(address(mAdapter), maturity, issuanceFee);
        address aTranche = factory.deployTranche(address(aAdapter), maturity, issuanceFee);
